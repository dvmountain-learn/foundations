...
//Code Here
let firstItem = arr[0]
console.log(`After assign item to first index: ${firstItem}`)
...
//Code Here
arr.pop()
console.log(`Remove last item from array: ${arr}`)
...
//Code Here
console.log('Using for loop, through the item of family')
for (let index = 0; index < family.length; index++) {
    console.log(`${family[index]}`)
}

console.log('Using foreach, through the item of family:')
family.forEach((name) => {
    console.log(name)
})
...
console.log(`Item of nums array: ${nums}`)
console.log(`Item of evens push by array nums: ${evensArr}`)
