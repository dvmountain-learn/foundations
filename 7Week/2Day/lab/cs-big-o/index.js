...
// ANSWER: O(1) because printNumbers function, it doesn't perform operations but instead of printing or measuring length of array without increase and output the result.
...
// ANSWER: O(n) because of the variable constant has a operator 1 * (1 + n)

// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER: O(n) because of the findFourth need to perform 1 * (1 + n) times so based on the variable count 
...
// ANSWER: 
function findFourth(numbers) {
  let answer = numbers.find((obj, index) => index === 4)
  console.log(answer)
}
...
// ANSWER: O(1) because we have a constant specifically in a number
...
// Q: What is the time complexity of this function?
// ANSWER: O(n) because of the number and length of arrays
