...
// CODE HERE
let newCities = cities.filter((city) => city.endsWith('i'))
...
// CODE HERE
// Solution # 1
let totalPriceByMap = foods.map(value => value.price).reduce((ac, price) => ac + price)
// Solution # 2
let totalPrice = foods.reduce((acc, cur) => {
  return acc + cur.price
}, 0)
// THE TOTAL
console.log(totalPriceByMap)
