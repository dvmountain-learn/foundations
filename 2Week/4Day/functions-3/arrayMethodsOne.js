...
// CODE HERE
const evenNumbers = mixedNumbers.filter((value) => { return value % 2 === 0 })
// mixedNumbers.filter((value) => value % 2 === 0)
...
// CODE HERE
const postTaxPrices = prices.map((value) => {
  return value * 1.07
}) 
// prices.map((value) => value * 1.07)
...
// CODE HERE
const totalPopulation = populations.reduce((total, value) => {
  return total + value
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((value) => { return value.CP > 200 }) // = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
// CODE HERE
// Solution #1
const bobsTotalByMap = purchases
                    .filter((value) => value.owner === 'Bob')
