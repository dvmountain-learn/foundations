...
function contains(array, name, callback) {
  if (array.includes(name)) callback(true) 
  else callback(false)
}
...
// CODE HERE
let items = ['U', 'N', 'I', 'Q', 'A', 'R', 'R', 'P', 'A', 'R', 'A', 'M']
uniq(names, function(result) {
  console.log(result)
})
...
// CODE HERE
let addNUMBER = addingFactory(999)
addNUMBER(168)
