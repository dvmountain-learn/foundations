...
let arrNum1 = arrNum.filter((num) => (num - 1) % 2 === 0)
console.log(arrNum1)
...
const arrNum2 = arrNum.filter((num, index) => {
    return (num -1) % 2 === 0 && (index - 1) % 2 === 0
})
console.log(arrNum2)
...
const arrString1 = arrString.filter((obj) => {
    return obj.toLowerCase().includes('a')
})
...
const sum1 = reduce1.reduce((a, c) => a + c)
console.log(sum1)
// 4.2
...
const sum2 = reduce1.reduce((a, c) => a + c, 100)
console.log(sum2)
