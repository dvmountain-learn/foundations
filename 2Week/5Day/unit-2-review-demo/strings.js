...
// trim removes whitespace (spaces, newlines, tabs) from the beginning 
...
let sentence = "My number " + num + "'s named " + first + " " + last + ": and you don't " + phrase +"!"
...
let wayOfStr = `My number ${num}'s named ${first} ${last}: and you don't ${phrase}!`
