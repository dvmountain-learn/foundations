...
//CODE HERE
function helloWorld(param = 'Hello, World!') {
  console.log(param)
}
// Calling 
helloWorld()
...
let arrowOptionalParam = _ => {
  return 'I am a JavaScript ninja!'
}
// Calling 
console.log(arrowOptionalParam())

let arrowOneLine = () => 'I am a JavaScript ninja!'
// Calling
console.log(arrowOneLine())
...
let nameGreeting = nameCheck('Jon')
...
// Expression
const faveColorFinderWithExpress = function(color) {
  if (color === 'red') return 'red is a great color'
  else if (color === 'green') return 'green is a solid favorite color'
  else if (color === 'black') return 'so trendy'
  else return 'you need to evaluate your favorite color choice'
...
// Arrow
const faveColorFinderWithArrow = (color) => {
  if (color === 'red') return 'red is a great color'
  else if (color === 'green') return 'green is a solid favorite color'
  else if (color === 'black') return 'so trendy'
  else return 'you need to evaluate your favorite color choice'
...
//CODE HERE
function theEliminator(params, loser) {
  for (let i = 0; i < params.length; i++) {
    if (params[i] === loser) {
      params.splice(i, 1)
    }
...
let resultOfEliminator = theEliminator(contestants, loser)
console.log(resultOfEliminator)
...
//CODE HERE
function convertStringToUpperCase(stringValue) {
  console.log(stringValue.toUpperCase())
}
convertStringToUpperCase(sampleString)
...
function emailCheck(email) {
  let emailWhiteSpace = String(email.trim())
  let replaceSpace = emailWhiteSpace.replace(' ', '')
  if (replaceSpace.includes('@')) return `${replaceSpace} email verified`
  else return 'must provide a valid email address'
}

let email = emailCheck('    senghort.rupp@  gmail.com    ')
console.log(email)
...
//CODE HERE
let totalFrogs2 = totalAmount(4) + 2
...
//CODE HERE
function isSortNumbers(params) {
  let startValue = params[0]
  for (let i = 0; i < params.length; i++) {
    if (startValue > params[i]) {
      return false
    } else {
      startValue = params[i]
    }
...
const arrayIsOrdered = (arrays) => {
  let startValue = arrays[0]
  for (let i = 0; i < arrays.length; i++) {
    if (startValue > arrays[i]) return false
    else startValue = arrays[i]
  }
  return true
}

const arrayIsEven = (arrays) => {
  for (let i = 0; i < arrays.length; i++) {
    if (arrays[i] % 2 !== 0) return false
  }
  return true
}

let arrayIsScending = isSortNumbers(sampleArray)
console.log(arrayIsScending)
let arrayIsOrderOutput = arrayIsOrdered(sampleArray)
console.log(arrayIsOrderOutput)
console.log(arrayIsEven(sampleArray))
